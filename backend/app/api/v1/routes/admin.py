...
Scope note: only the dashboard is built here. Full financial reports,
business KPIs and analytics were explicitly deferred — none of them
existed in this codebase before, and they are a product to design, not
a permission to flip. What this module establishes now is the boundary
they will live behind.
"""
...
from app.schemas.admin import AdminDashboard, DailyRevenuePoint
